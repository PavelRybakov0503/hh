...
class ApiHH(GetApiHH):
    ...
    def format_json(self) -> list:
        """
            Форматирует данные вакансий для каждого работодателя.

            Эта функция получает данные вакансий, фильтрует их по идентификаторам работодателей
            и возвращает список словарей, где каждый словарь содержит идентификатор работодателя
            и соответствующие вакансии.

            Возвращает:
                list: Список словарей с идентификаторами работодателей и их вакансиями.
        """
